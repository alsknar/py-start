...
z = x + y
print('Сумма комплексных чисел ', z)

z = x * y
print('Умножение комплексных чисел ', z)

z = x / y
print('Деление комплексных чисел ', z)
...
print('Комплексные числа можна проверить на равенство, но нельзя сравнить ', x == y)

print('Модкль комплесного числа ', abs(z))

print('Возведение в степень комплексного числа ', pow(z,2))
